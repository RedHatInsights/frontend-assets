...
| <img src="src/ask-redhat/ask-redhat-icon.svg" alt="ask-redhat-icon" width="24" height="24" /> | `AskRedhatAskRedhatIconIcon` | `ask-redhat-icon.svg` | `/ask-redhat/ask-redhat-icon.svg` | `/ask-redhat/ask-redhat-icon.tsx` |
