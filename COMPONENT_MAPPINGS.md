...
| <img src="src/technology-icons/ai-chat-ask-redhat.svg" alt="ai-chat-ask-redhat" width="24" height="24" /> | `AiChatAskRedhatIcon` | `ai-chat-ask-redhat.svg` | `/technology-icons/ai-chat-ask-redhat.svg` | `/technology-icons/ai-chat-ask-redhat.tsx` |
| <img src="src/technology-icons/ai-chat-chameleon.svg" alt="ai-chat-chameleon" width="24" height="24" /> | `AiChatChameleonIcon` | `ai-chat-chameleon.svg` | `/technology-icons/ai-chat-chameleon.svg` | `/technology-icons/ai-chat-chameleon.tsx` |
...
| <img src="src/background-images/ansiblefest-collage-anisble-ai-sparkles-RH.svg" alt="ansiblefest-collage-anisble-ai-sparkles-RH" width="24" height="24" /> | `AnsiblefestCollageAnisbleAiSparklesRHIcon` | `ansiblefest-collage-anisble-ai-sparkles-RH.svg` | `/background-images/ansiblefest-collage-anisble-ai-sparkles-RH.svg` | `/background-images/ansiblefest-collage-anisble-ai-sparkles-RH.tsx` |
...
| <img src="src/background-images/collage-openshiftvirt-server-white-RH.Large_square_transparent.svg" alt="collage-openshiftvirt-server-white-RH.Large_square_transparent" width="24" height="24" /> | `CollageOpenshiftvirtServerWhiteRHLargeSquareTransparentIcon` | `collage-openshiftvirt-server-white-RH.Large_square_transparent.svg` | `/background-images/collage-openshiftvirt-server-white-RH.Large_square_transparent.svg` | `/background-images/collage-openshiftvirt-server-white-RH.Large_square_transparent.tsx` |
| <img src="src/background-images/collages-rhel-rhel-icon-sparkles-RH.svg" alt="collages-rhel-rhel-icon-sparkles-RH" width="24" height="24" /> | `CollagesRhelRhelIconSparklesRHIcon` | `collages-rhel-rhel-icon-sparkles-RH.svg` | `/background-images/collages-rhel-rhel-icon-sparkles-RH.svg` | `/background-images/collages-rhel-rhel-icon-sparkles-RH.tsx` |
| <img src="src/background-images/Collage-Summit-AI-inference-time-purple-RH.svg" alt="Collage-Summit-AI-inference-time-purple-RH" width="24" height="24" /> | `CollageSummitAIInferenceTimePurpleRHIcon` | `Collage-Summit-AI-inference-time-purple-RH.svg` | `/background-images/Collage-Summit-AI-inference-time-purple-RH.svg` | `/background-images/Collage-Summit-AI-inference-time-purple-RH.tsx` |
