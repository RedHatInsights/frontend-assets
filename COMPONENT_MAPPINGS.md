...
| <img src="src/background-images/collage-anisble-ai-sparkles.svg" alt="collage-anisble-ai-sparkles" width="24" height="24" /> | `CollageAnisbleAiSparklesIcon` | `collage-anisble-ai-sparkles.svg` | `/background-images/collage-anisble-ai-sparkles.svg` | `/background-images/collage-anisble-ai-sparkles.tsx` |
| <img src="src/background-images/collage-openshift-virt-server-white.svg" alt="collage-openshift-virt-server-white" width="24" height="24" /> | `CollageOpenshiftVirtServerWhiteIcon` | `collage-openshift-virt-server-white.svg` | `/background-images/collage-openshift-virt-server-white.svg` | `/background-images/collage-openshift-virt-server-white.tsx` |
| <img src="src/background-images/collage-rhel-icon-sparkles.svg" alt="collage-rhel-icon-sparkles" width="24" height="24" /> | `CollageRhelIconSparklesIcon` | `collage-rhel-icon-sparkles.svg` | `/background-images/collage-rhel-icon-sparkles.svg` | `/background-images/collage-rhel-icon-sparkles.tsx` |
...
Total components generated: 234
